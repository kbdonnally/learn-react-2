...
class Random extends React.Component {
	...
	isLight() {
		...
		// if it's more or less than halfway dark 
	...
	chooseColor() {
		...
		for (let i=0; i<3; i++) {
			...
			// select a random number between 0 and 255
	...
	render() {
		return (
			// if isLight() is true, the bg color is dark with white text
...
ReactDOM.render(
	<Random />,
	document.getElementById('random-color-picker')
);